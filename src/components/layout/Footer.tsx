  ...
  return (
    <footer className="bg-dsu-navy text-white pt-20 pb-10 px-6 sm:px-12 border-t mt-auto z-50 relative">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div className="col-span-1 lg:col-span-1 flex flex-col h-full bg-white p-1 rounded-xl">
          <div className="flex-1 w-full bg-gray-800 rounded-lg overflow-hidden min-h-[200px] border border-white/10">
            <iframe 
        ...
        {/* Right: Branding & Addresses */}
        <div className="col-span-1 lg:col-span-1 flex flex-col items-start lg:items-end text-left lg:text-right">
          ...
          <div className="space-y-6 text-sm text-gray-300 w-full flex flex-col items-start lg:items-end">
            <div className="flex flex-col gap-1 items-start lg:items-end w-full">
              ...
              <p className="mt-1">E-mail: admissions@dsu.edu.in</p>
            </div>
            
            <div className="w-8 border-b border-dsu-gold/30 my-1 hidden lg:block"></div>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
        <p className="text-sm text-gray-400">
          © {new Date().getFullYear()} Aniket Kumar Singh. All Rights Reserved.
        </p>
        <div className="flex gap-4">
          <Link href="#" aria-label="Facebook" className="text-gray-300 hover:text-dsu-gold transition-colors">
          ...
          <Link href="#" aria-label="Twitter" className="text-gray-300 hover:text-dsu-gold transition-colors">
          ...
          <Link href="#" aria-label="Instagram" className="text-gray-300 hover:text-dsu-gold transition-colors">
          ...
          <Link href="#" aria-label="LinkedIn" className="text-gray-300 hover:text-dsu-gold transition-colors">
          ...
          <Link href="#" aria-label="YouTube" className="text-gray-300 hover:text-dsu-gold transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M21.58 7.19a2.71 2.71 0 0 0-1.91-1.92c-1.68-.45-8.47-.45-8.47-.45s-6.79 0-8.47.45A2.71 2.71 0 0 0 .82 7.19C.37 8.87.37 12 .37 12s0 3.13.45 4.81a2.71 2.71 0 0 0 1.91 1.91c1.68.45 8.47.45 8.47.45s6.79 0 8.47-.45a2.71 2.71 0 0 0 1.91-1.91C22 15.13 22 12 22 12s0-3.13-.42-4.81zm-11.88 7v-5.46l5.22 2.73-5.22 2.73z"/></svg>
          </Link>
        </div>
      </div>
    </footer>
